...
class App extends Component {
	...
	deleteColumn(event) {
		this.props.onDeleteColumn(event.target.dataset.column);
	}
	readInputName(event) {
			...
			<div>
				<div className="main">
					{this.props.columns.map((column, index) =>
						...
						<div className="Delete_column_button">
						<button className={column.buttonAddColumnClass} id="Delete_column" data-column={column.id} onClick={this.deleteColumn.bind(this)}>-</button>
						</div>
...
export default connect(
	...
	dispatch => ({
		...
		onDeleteColumn: (column) => {
			dispatch({ type: 'DELETE_COLUMN', payload: column });
		},
